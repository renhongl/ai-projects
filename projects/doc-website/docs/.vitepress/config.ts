      ...
      '/engineering/': [
        {
          ...
          items: [
            ...
            { text: '01 Engineering Overview', link: '/engineering/01-overview' },
            { text: '02 Vite', link: '/engineering/02-vite' },
            { text: '03 Webpack', link: '/engineering/03-webpack' },
            { text: '04 Babel and ESBuild', link: '/engineering/04-babel-esbuild' },
            { text: '05 Code Splitting', link: '/engineering/05-code-splitting' },
            { text: '06 Asset Optimization', link: '/engineering/06-asset-optimization' },
            ...
            { text: '17 Team Governance', link: '/engineering/17-team-governance' }
          ]
        }
      ],
      '/english/': [
        {
          ...
          items: [
            ...
            { text: '01 Exercise Changes the Brain', link: '/english/01-exercise-changes-brain' }
          ]
        }
      ]
    },
