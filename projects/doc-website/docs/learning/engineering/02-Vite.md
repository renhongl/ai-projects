...
对应示例文件：
- `projects/vite-learning-lab/index.html`
...
对应示例文件：
- `projects/vite-learning-lab/vite.config.ts`
...
对应示例文件：
- `projects/vite-learning-lab/.env.development`
- `projects/vite-learning-lab/.env.production`
- `projects/vite-learning-lab/src/main.ts`
- `projects/vite-learning-lab/src/vite-env.d.ts`
...
对应示例文件：
- `projects/vite-learning-lab/src/assets/vite-mark.svg`
- `projects/vite-learning-lab/public/robots.txt`
- `projects/vite-learning-lab/src/main.ts`
...
- `projects/vite-learning-lab/vite.config.ts`
- `projects/vite-learning-lab/src/main.ts`
- `projects/vite-learning-lab/tsconfig.json`
...
对应示例文件：
- `projects/vite-learning-lab/src/main.ts`
- `projects/vite-learning-lab/src/modules/feature.ts`
...
1. 先读 `projects/vite-learning-lab/README.md`，明确项目目标。
2. 再看 `projects/vite-learning-lab/vite.config.ts`，把配置项和效果一一对应起来。
3. 然后读 `projects/vite-learning-lab/src/main.ts`，理解 Vite 在业务代码里的具体用法。
