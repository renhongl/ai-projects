...
对应示例：
- [index.html](/D:/FE/ai-projects/projects/vite-learning-lab/index.html:1)
...
对应示例：
- [vite.config.ts](/D:/FE/ai-projects/projects/vite-learning-lab/vite.config.ts:1)
...
对应示例：
- [`.env.development`](</D:/FE/ai-projects/projects/vite-learning-lab/.env.development:1>)
- [`.env.production`](</D:/FE/ai-projects/projects/vite-learning-lab/.env.production:1>)
- [main.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/main.ts:1)
- [vite-env.d.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/vite-env.d.ts:1)
...
对应示例：
- [vite-mark.svg](/D:/FE/ai-projects/projects/vite-learning-lab/src/assets/vite-mark.svg:1)
- [robots.txt](/D:/FE/ai-projects/projects/vite-learning-lab/public/robots.txt:1)
- [main.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/main.ts:1)
...
- [vite.config.ts](/D:/FE/ai-projects/projects/vite-learning-lab/vite.config.ts:1)
- [main.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/main.ts:1)
- [tsconfig.json](/D:/FE/ai-projects/projects/vite-learning-lab/tsconfig.json:1)
...
对应示例：
- [main.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/main.ts:1)
- [feature.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/modules/feature.ts:1)
...
项目路径：
- [projects/vite-learning-lab](/D:/FE/ai-projects/projects/vite-learning-lab)
...
1. 先读 [README.md](/D:/FE/ai-projects/projects/vite-learning-lab/README.md:1)，明确项目目标。
2. 再看 [vite.config.ts](/D:/FE/ai-projects/projects/vite-learning-lab/vite.config.ts:1)，把配置项和效果一一对应起来。
3. 然后读 [main.ts](/D:/FE/ai-projects/projects/vite-learning-lab/src/main.ts:1)，理解 Vite 在业务代码里的具体用法。
